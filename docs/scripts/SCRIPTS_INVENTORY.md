...
| 文件名 | 大小 | 描述 |
|--------|------|------|
| `docs/getting_started/BUILD_AND_TEST.md` | 5.8K | 详细使用指南，包含所有选项说明 |
...
│
└── 文档
    ├── docs/getting_started/BUILD_AND_TEST.md         ← 使用指南
...
### 清理功能（已合并）
交互式清理功能已合并到 `build_and_test.sh --clean`。在交互式终端将提示确认；在非交互环境或设置 `FORCE_CLEAN=1` 时会直接删除。
