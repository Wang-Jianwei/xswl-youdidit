/* DEPRECATED: This file was moved to `web/src/web_dashboard.cpp` and retained here only as a placeholder.
   Please use the implementation under `web/src/` and remove this file when safe. */

// Placeholder to avoid accidental usage
